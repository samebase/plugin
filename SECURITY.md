...
Use
[GitHub private vulnerability reporting](https://github.com/samebase/agent-plugins/security/advisories/new)
...
Use [GitHub Issues](https://github.com/samebase/agent-plugins/issues) for non-sensitive bugs and
support requests.
